...
class EmpleadoController extends Controller
{
    ...
    /**
     * Store a newly created resource in storage @csrf.
     */
    public function store(Request $request)
    {
        //
        $empleado=new Empleado();
        $empleado->codeempleado=$request->get('codigoEmpleado');
    ...
    public function show(string $id)
    {
        ...
        return view('empleado.delete')->with('eliminarRegistro2',$eliminarRegistro);
    }
