...
class DepositoController extends Controller
{
    ...
    {
        //
        return view('deposito.create')->with('id',$id)->with('id2',$id2);
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('deposito.index')->with('depositos',$depositos)->with("afiliado",$request->get('codafiliado'));
    ...
    public function show(string $id,string $id2)
    {
        ...
        $depositos=Deposito::all();
        return view('deposito.index2')->with('depositos',$depositos)
